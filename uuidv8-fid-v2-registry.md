# UUIDv8-FID-v2 Format Type and Subtype Registry

## 1. Status of This Document

This document defines the registry document for **UUIDv8-FID-v2 Format Type and Subtype assignments**, abbreviated as the **UUIDv8-FID-v2 Registry**.

This document is separate from the UUIDv8-FID-v2 field-format specification. The field-format specification defines the bit-level structure of UUIDv8-FID-v2 values. This registry defines concrete assignments for `format_type`, `format_subtype`, and the combined `format_id` value.

This initial version is a registry scaffold. Concrete assignments are to be added as profile-specific formats are defined.

## 2. Relationship to UUIDv8-FID-v2
...
This registry assigns meanings to selected `format_type` and `format_subtype` values. The field-format specification remains valid independently of this registry.
...
Those items are defined by the UUIDv8-FID-v2 field-format specification.
